    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Create Blog</h1>
                <!--end::Title-->
            </div>
                    ...
                    <form id="kt_modal_new_target_form" class="form" action="{{route('admin.blog.store')}}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid" placeholder="Enter Blog Title" name="blog_title" value="{{old('blog_title')}}" />
                                @error('blog_title')
