                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            @foreach($blogs as $row)
                                <tr>
                                    ...
                                    <td class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-50px overflow-hidden me-3">
                                                <div class="symbol-label">
                                                    <img src="{{asset('public/uploads/blogs/')}}/{{$row->image}}" alt="Francis Mitcham" class="w-100" />
                                                </div>
                                        </div>
                                        <!--end::Avatar-->
                                    </td>
                                    ...
                                    <!--begin::Last login=-->
                                    <td>
                                        <div class="badge badge-light fw-bolder">{!! \Illuminate\Support\Str::limit($row->details, 100, $end='...') !!}</div>
                                    </td>
                                    <td>
                                        <div class="badge badge-light fw-bolder">{{$row->category->name ??' '}}</div>
                                    </td>
                                    <!--end::Last login=-->
                                    <!--begin::Two step=-->
                                    <td>{{$row->creadedby->user_name ?? ' '}}</td>
                                    <!--end::Two step=-->
                                    <!--begin::Joined-->
                                    ...
                                    <td class="text-end">
                                                @if($row->status==1)
                                                <a href="{{route('admin.blog.status.change',$row->id)}}" title="status" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                @else
                                                <a href="{{route('admin.blog.status.change',$row->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    <span class="svg-icon svg-icon-3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                <rect x="0" y="0" width="24" height="24" />
