            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.blog.category.update',$category->id) }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                    ...
                                    @foreach($categores as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $data->name  }}</a>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                @if($data->status==1)
                                                <a href="{{route('admin.blog.category.status.change',$data->id)}}" title="status" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                @else
                                                <a href="{{route('admin.blog.category.status.change',$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    <span class="svg-icon svg-icon-3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                <rect x="0" y="0" width="24" height="24" />
                                                ...
                                                @endif
                                                <a href="{{route('admin.blog.category.edit',$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                <a id="delete" href="{{route('admin.blog.category.delete',$data->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
