    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card">
                ...
                <!--end::Header-->
                <!--begin::Form-->
                <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.seo') }}" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Body-->
                    <div class="card-body" data-select2-id="select2-data-90-elj6">
                        <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                            <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">Meta Title:</label>
                                ...
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">Meta Author:</label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                ...
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">Meta Keyword:</label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" value="{{$edit->meta_keyword}}" name="meta_keyword" />
                                        </div>
                                    </div>		<!--end::Label-->
                                ...
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">Meta Description:</label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="text" name="google_verification" placeholder="Meta Description" value="{{$edit->meta_description}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="text" name="bing_verification" placeholder="Meta Description" value="{{$edit->meta_description}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <textarea class="form-control form-control-solid" type="text" name="google_analytics" placeholder="Meta Description">{{$edit->meta_description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <textarea class="form-control form-control-solid" type="text" name="alexa_analytics" placeholder="Meta Description">{{$edit->meta_description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
