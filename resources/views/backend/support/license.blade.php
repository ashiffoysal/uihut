    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Licensing</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Licensing</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.license.update') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">SubText:</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input type="hidden" name="id" value="{{ $edit->id }}">
                                                    <textarea class="form-control form-control-solid" type="text" name="subtext">{{ $edit->subtext }}</textarea>
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Aggrement:</label>
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input type="hidden" name="id" value="{{ $edit->id }}">
                                                    <textarea class="form-control form-control-solid" type="text" name="aggrement">{{ $edit->aggrement }}</textarea>
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">You Can:</label>
                                            <div class="col-lg-9 col-xl-9">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input type="hidden" name="id" value="{{ $edit->id }}">
                                                    <textarea class="form-control form-control-solid" type="text" id="youcan" name="you_can">{{ $edit->you_can }}</textarea>
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">You Can Not:</label>
                                            <div class="col-lg-9 col-xl-9">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input type="hidden" name="id" value="{{ $edit->id }}">
                                                    <textarea class="form-control form-control-solid" type="text" id="youcannot" name="you_cannot">{{ $edit->you_cannot }}</textarea>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input type="hidden" name="id" value="{{ $edit->id }}">
                                                    <textarea class="form-control form-control-solid" id="editor1" type="text" name="details">{{ $edit->details }}</textarea>
