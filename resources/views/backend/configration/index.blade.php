        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Configration</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header card-header-stretch overflow-auto">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Email Configration</span>
                    </h3>
                </div>
                <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.generalsetting') }}" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Body-->
                                ...
                                <div class="row mb-10">
                                    ...
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            ...
                                            <input class="form-control form-control-solid" type="text" name="company_name" value="" placeholder="CLIENT ID">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">Secret Key:</label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input class="form-control form-control-solid" type="text" name="company_motto" value="" placeholder="SECRET KEY">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-header card-header-stretch overflow-auto">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Facebook Configration</span>
                    </h3>
                </div>
                <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.generalsetting') }}" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="card">
                <div class="card-header card-header-stretch overflow-auto">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Paddle Configration</span>
                    </h3>
                </div>
                <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.configration.index') }}">
                    @csrf
                    ...
                    <div class="card-body" data-select2-id="select2-data-90-elj6">
                        <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                            <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">PADDLE VENDOR ID:</label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input type="hidden" name="types[]" value="PADDLE_VENDOR_ID">
                                            <input class="form-control form-control-solid" type="text" name="PADDLE_VENDOR_ID" value="{{ env('PADDLE_VENDOR_ID') }}" placeholder="PADDLE VENDOR ID" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">AUTH CODE:</label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input type="hidden" name="types[]" value="PADDLE_VENDOR_AUTH_CODE">
                                            <input class="form-control form-control-solid" type="text" name="PADDLE_VENDOR_AUTH_CODE" value="{{ env('PADDLE_VENDOR_AUTH_CODE') }}" placeholder="PADDLE VENDOR AUTH CODE">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-10">
                                    <label class="col-lg-3 col-form-label text-lg-end">PUBLIC KEY:</label>
                                    <div class="col-lg-9 col-xl-4">
                                        <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                            <input type="hidden" name="types[]" value="PADDLE_PUBLIC_KEY">
                                            <input class="form-control form-control-solid" type="text" name="PADDLE_PUBLIC_KEY" value="{{ env('PADDLE_PUBLIC_KEY') }}" placeholder="PADDLE_PUBLIC_KEY">
                                        </div>
                                    </div>
                                </div>
                            </div>
