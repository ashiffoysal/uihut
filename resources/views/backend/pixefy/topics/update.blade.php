    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Update Pixefy Topics</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <!--begin::Description-->
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Topic</p>
                    </div>
                    <!--end::Description-->
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.pixefy.topic.update',$topic->id) }}">
                            @csrf
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Topic Name:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="name" value="{{$topic->name}}" >
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">All Topics</span>
                            </h3>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            @foreach($topics as $row)
                                <tr>
                                    ...
                                    <td class="text-end">
                                                @if($row->status==1)
                                                <a href="{{route('admin.pixefy.topic.status.change',$row->id)}}" title="status" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                @else
                                                <a href="{{route('admin.pixefy.topic.status.change',$row->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    <span class="svg-icon svg-icon-3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                <rect x="0" y="0" width="24" height="24" />
                                                ...
                                                @endif
                                                <a href="{{route('admin.pixefy.topic.edit',$row->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                <a id="delete" href="{{route('admin.pixefy.topics.delete',$row->id)}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
