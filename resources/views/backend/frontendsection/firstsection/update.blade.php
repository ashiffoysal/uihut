    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3 flex-wrap mb-5 mb-lg-0 lh-1">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">FrontEnd Home Section</h1>
                <!--end::Title-->
            </div>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="card mb-10">
                <div class="card-body d-flex align-items-center p-5 p-lg-8">
                    ...
                    <div class="ms-6">
                        <p class="list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0">Update Home First Section</p>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form" method="POST" id="kt_layout_builder_form" action="{{ route('admin.firstsection.update') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body" data-select2-id="select2-data-90-elj6">
                                <div class="tab-content pt-3" data-select2-id="select2-data-89-mk7z">
                                    <div class="tab-pane active" id="kt_builder_main" data-select2-id="select2-data-kt_builder_main">
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Heading Text:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <input class="form-control form-control-solid" type="text" name="heading_text" placeholder="Heading Text" value="{{$edit->heading_text}}">
                                        ...
                                        <div class="row mb-10">
                                            <label class="col-lg-3 col-form-label text-lg-end">Sub-Text:</label>
                                            <div class="col-lg-9 col-xl-4">
                                                <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                                                    <textarea class="form-control form-control-solid" type="text" name="sub_text" placeholder="SubHeading Text">{{ $edit->sub_text}}</textarea>
                                        ...
                                        <div class="row mb-10">
                                            ...
                                            <div class="col-lg-3 col-xl-2">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(assets/media/avatars/blank.png)">
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{Storage::url('/'.$edit->video_link)}})"></div>
                                        
                                         
                                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                                                        <i class="bi bi-pencil-fill fs-7"></i>
                                                        <input type="file" name="video_link" accept=".png, .jpg, .jpeg, .gif,.mp4" />
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-lg-3 col-xl-3">
                                                <iframe src="{{url('public/storage/'.$edit->video_link)}}" frameborder="1"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
